...
var MainLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        enemy1.x = cc.winSize.width / 3;
        enemy1.y = cc.winSize.height*0.8;
        ...
        this.schedule(this.enemyCallback1,0.001);
        return true;
    },
    ...
    enemyCallback1: function (dt) {
        if (this.enemy1.y < 0) {
            ...
            //碰撞检测
            if(cc.rectContainsPoint(this.plane.getBoundingBox(),this.enemy1.getPosition())){
                //cc.log("碰到了");
                var ls = cc.sys.localStorage;
                ls.setItem("currentScore",this.score);
                if(this.score > ls.getItem("bestScore")){
